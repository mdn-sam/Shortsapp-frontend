      ...
      >
        <button
          ...
          style={{
            ...
            padding: '4px 8px',
            borderRadius: 4,
            backgroundColor: currentSource === 'rumble' ? 'rgba(255,255,0,0.7)' : 'transparent',
            color: currentSource === 'rumble' ? 'black' : 'white',
        ...
        <button
          ...
          style={{
            ...
            padding: '4px 8px',
            borderRadius: 4,
            backgroundColor: currentSource === 'odysee' ? 'rgba(255,255,0,0.7)' : 'transparent',
            color: currentSource === 'odysee' ? 'black' : 'white',
            border: '1px solid white',
            cursor: 'pointer',
          }}
        ...
        >
          {loading ? 'Loading...' : `Load ${currentSource === 'rumble' ? 'Rumble' : 'Odysee'}`}
        </button>
      </div>
